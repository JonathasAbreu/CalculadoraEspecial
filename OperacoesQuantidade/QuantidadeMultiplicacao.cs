...
namespace Calculadora.OperacoesMatematicas.OperacoesQuantidade
{
    public class QuantidadeMultiplicacao
    {
        ...
        public static decimal MultiplicarSequencial(params decimal[] valores)
        {
        ...
        public static void DoisNumeros()
        {
            try
            {
                ...
                decimal divisao = MultiplicarSequencial(valor1, valor2);

                Console.Clear();
                Console.WriteLine($"O resultado da sua multiplicação foi: {divisao:F2}\n");
        ...
        public static void TresNumeros()
        {
            try
            {
                ...
                decimal divisao = MultiplicarSequencial(valor1, valor2, valor3);
